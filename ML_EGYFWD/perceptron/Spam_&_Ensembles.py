...
classifier1=BaggingClassifier(n_estimators=200)
...
classifier3=AdaBoostClassifier(n_estimators=300,learning_rate=0.2)
...
classifier1.fit(training_data,y_train)

# Fit your RandomForestClassifier to the training data
classifier2.fit(training_data,y_train)

# Fit your AdaBoostClassifier to the training data
classifier3.fit(training_data,y_train)
...
y_predict1=classifier1.predict(testing_data)

# Predict using RandomForestClassifier on the test data
y_predict2=classifier2.predict(testing_data)


# Predict using AdaBoostClassifier on the test data
y_predict3=classifier3.predict(testing_data)
...
print('Bagging scores',print_metrics(y_test,y_predict1))

# Print Random Forest scores
print('Random Forest scores',print_metrics(y_test,y_predict2))

# Print AdaBoost scores
print('AdaBoost scores',print_metrics(y_test,y_predict3))
